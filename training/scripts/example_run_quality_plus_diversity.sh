...
VERL_ARGS+=(
    ...
    "+reward.custom_reward_function.reward_kwargs.rm_server_url='$RM_SERVER_URL'"
    ...
    "+reward.custom_reward_function.reward_kwargs.bigram_gamma=0.0"
    "+reward.custom_reward_function.reward_kwargs.trigram_gamma=0.0"
    "+reward.custom_reward_function.reward_kwargs.diversity_weight=$DIVERSITY_WEIGHT"
