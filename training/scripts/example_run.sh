...
VERL_ARGS+=(
    "+custom_reward_function.reward_kwargs.reward_mode=diversity_only"
    ...
    "+custom_reward_function.reward_kwargs.bigram_gamma=$BIGRAM_GAMMA"
    "+custom_reward_function.reward_kwargs.trigram_gamma=$TRIGRAM_GAMMA"
